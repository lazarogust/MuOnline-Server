				 ...
				 WORD SkillIndex,WORD Skill,WORD SKKey)
{
    ...
    else
    {
        ...
        {
			case MODEL_BOW+8 :
				CreateEffect(MODEL_ARROW_STEEL  ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+9 :
				CreateEffect(MODEL_ARROW_STEEL  ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+10:
				CreateEffect(MODEL_ARROW_SAW    ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+11:
				CreateEffect(MODEL_ARROW_LASER  ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+12:
				CreateEffect(MODEL_ARROW_THUNDER,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+13:
				CreateEffect(MODEL_ARROW_WING   ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+14:
				CreateEffect(MODEL_ARROW_BOMB   ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+16:
				CreateEffect(MODEL_ARROW_DOUBLE ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+18:
				CreateEffect(MODEL_ARROW_BEST_CROSSBOW,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);
				break;
			case MODEL_BOW+19:
				CreateEffect(MODEL_ARROW_DRILL,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			default:
				if (gCustomBow.CheckIsCrossBow(Right - MODEL_ITEM))
				{
					CreateEffect(gCustomBow.GetSkillNumber(Right - MODEL_ITEM), o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
					return;
				}
				break;
        }
        ...
        {
			case MODEL_BOW  :
				CreateEffect(MODEL_ARROW        ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+1:
				CreateEffect(MODEL_ARROW        ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+2:
				CreateEffect(MODEL_ARROW_V      ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+3:
				CreateEffect(MODEL_ARROW        ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+4:
				CreateEffect(MODEL_ARROW        ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+5:
				CreateEffect(MODEL_ARROW        ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+6:
				CreateEffect(MODEL_ARROW_NATURE ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+17:
				CreateEffect(MODEL_ARROW_HOLY  ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+20:
				CreateEffect(MODEL_LACEARROW   ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+21:
				CreateEffect(MODEL_ARROW_SPARK ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+22:
				CreateEffect(MODEL_ARROW_RING   ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			case MODEL_BOW+23:
				CreateEffect(MODEL_ARROW_DARKSTINGER   ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;	
			case MODEL_BOW+24:
				CreateEffect(MODEL_ARROW_GAMBLE ,o->Position,o->Angle,o->Light,SubType,o,o->PKKey,SkillIndex,Skill);break;
			default:
				if (gCustomBow.CheckIsBow(Left - MODEL_ITEM))
				{
					CreateEffect(gCustomBow.GetSkillNumber(Left - MODEL_ITEM), o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
					return;
				}
				break;
        }                                                                               
