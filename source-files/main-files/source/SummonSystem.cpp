...
{
	if (pCharacter->Helper.Type == MODEL_HELPER + 2 || gHelperSystem.CheckHelperType(pCharacter->Helper.Type, 2))
	{
		SetAction(pObject, PLAYER_SKILL_SUMMON_UNI);
	}
	else if (pCharacter->Helper.Type == MODEL_HELPER + 3 || gHelperSystem.CheckHelperType(pCharacter->Helper.Type, 4))
	{
		SetAction(pObject, PLAYER_SKILL_SUMMON_DINO);
	}
	else if (pCharacter->Helper.Type == MODEL_HELPER + 37 || gHelperSystem.CheckHelperType(pCharacter->Helper.Type, 8))
	{
