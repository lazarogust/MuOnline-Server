...
void M39Kanturu3rd::Kanturu3rdSuccess()
{
	...
	EnableAlphaTest();
	RenderBitmap( BITMAP_KANTURU_SUCCESS, setPosMidRight(fPosX), fPosY, fWidth, fHeight, 0.f, 0.f, tu, tv,true,true, fAlpha);
}
...
void M39Kanturu3rd::Kanturu3rdFailed()
{
	...
	EnableAlphaTest();
	RenderBitmap( BITMAP_KANTURU_FAILED, setPosMidRight(fPosX), fPosY, fWidth, fHeight, 0.f, 0.f, tu, tv,true,true, fAlpha);
}
