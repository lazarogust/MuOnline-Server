...
//-----------------------------
	...
	case WM_MOUSEMOVE:
		{
			// - ConverCursor & CompareToCursor (1.04E)
...
//#ifdef _DEBUG
	...
	case 4:WindowWidth = 1360; WindowHeight = 768; break;
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int nCmdShow)
{
	...
	if (gProtect->ReadMainFile("Data\\Configs\\Configs.xtm") == 0)
	{
		MessageBox(0, "Erro de configura豫o. Consulte o suporte! #1", "Erro de inicializa豫o!", MB_OK | MB_ICONERROR);
		ExitProcess(0);
	}
	if (gProtect->ReadCustomJewelConfig(("Data\\Configs\\CustomJewel.xtm")) == 0)
	{
		MessageBox(0, "Erro de configura豫o. Consulte o suporte! #2", "Erro de inicializa豫o!", MB_OK | MB_ICONERROR);
		ExitProcess(0);
	}
