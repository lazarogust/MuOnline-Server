...
bool M34CryWolf1st::Render_Mvp_Interface()
{
	...
	if(TimeStart = true)
	{
		...
		RenderNumber2D(setPosRight(510 + 60), 384 + 18, nPastMinute, 14, 14);
		if(nPastTick == 0)
			RenderNumber2D(setPosRight(520 + 87), 384 + 18, nPastTick, 14, 14);
		else
			RenderNumber2D(setPosRight(520 + 87), 384 + 18, 60 - nPastTick, 14, 14);
	}
