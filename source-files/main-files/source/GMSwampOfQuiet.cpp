...
void GMSwampOfQuiet::RenderBaseSmoke()
{
	...
	RenderBitmapUV(BITMAP_CHROME+3,0.f,0.f,640.f + GWidescreen.DisplayWinCDepthBox, 480.0,WindX2,0.f,3.f,2.f);
	EnableAlphaBlend();
	float WindX = (float)((int)WorldTime%100000)*0.0002f; 
	RenderBitmapUV(BITMAP_CHROME+2,0.f,0.f,640.f + GWidescreen.DisplayWinCDepthBox, 480.0,WindX,0.f,0.3f,0.3f);
}
...
// 		}
	...
	case 445:
		...
		strcpy(pCharacter->ID,"½¦µµ¿ì ³ªÀÌÆ®");
		pCharacter->Object.Scale = 1.1f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		pCharacter->Object.LifeTime = 100;
	...
	case 448:
		...
		strcpy(pCharacter->ID,"°í½ºÆ® ³×ÀÌÇÉ");
		pCharacter->Object.Scale = 0.95f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		break;
	case 449:
		...
		strcpy(pCharacter->ID,"ºí·¹ÀÌÁî ³×ÀÌÇÉ");
		pCharacter->Object.Scale = 0.95f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		break;
	...
	case 558:
		...
		strcpy(pCharacter->ID,"¾ÆÀÌ½º ³×ÀÌÇÉ");
		pCharacter->Object.Scale = 1.1f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		break;
