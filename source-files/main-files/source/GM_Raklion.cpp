	...
	case 562:
		{
			...
			strcpy(pCharacter->ID, "늚� 자이언트 매머드");
			//pCharacter->Object.Scale = 1.7f;
	...
	case 565:
		{
			...
			strcpy(pCharacter->ID, "늚� 아이언 나이트");
			//pCharacter->Object.Scale = 1.5f;
...
void CGM_Raklion::RenderBaseSmoke()
{
	...
	RenderBitmapUV(BITMAP_CHROME+3,0.f,0.f,640.f + GWidescreen.DisplayWinCDepthBox, 480.0,WindX2,WindY2,3.0f,2.0f);
