	...
	case WEATHER_FOG:
		{
			...
			RenderBitmapUV(BITMAP_CHROME+2,0.f,0.f,640.f + GWidescreen.DisplayWinCDepthBox, 480.0,WindX2,WindY2,2.0f,2.0f);
	...
	case WEATHER_STORM:
		{
			if( rand()%20 == 0 )
			{
				...
				RenderBitmapUV(BITMAP_CHROME+2,0.f,0.f,640.f + GWidescreen.DisplayWinCDepthBox, 480.0,WindX2,WindY2,3.0f,2.0f);
